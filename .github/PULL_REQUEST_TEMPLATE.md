<!--
  Thank you for your contribution to the Kotlin Service Template! We appreciate your efforts.
  ...
  4. **Code Style**: Check your code with [Ktlint](https://github.com/pinterest/ktlint) and [its gradle plugin](https://github.com/JLLeitschuh/ktlint-gradle) (`./gradlew ktlintCheck`).
  ...
  For more details on contributing, please refer to our guide: https://github.com/lengors/kotlin-service-template/blob/main/CONTRIBUTING.md
-->
