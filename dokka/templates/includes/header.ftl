...
<#macro display>
    <nav class="navigation theme-dark" id="navigation-wrapper">
        ...
        <div class="navigation-controls">
            ...
            <a class="navigation-controls--btn navigation-controls--theme navigation-controls--github" id="github-toggle-button" role="button" alt="GitHub" href="https://github.com/lengors/kotlin-service-template">
                GitHub
            </a>
